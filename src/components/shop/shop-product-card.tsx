...
function CardBadge({
  ...
  // Fixed neutrals: the chip always sits on the white studio photograph,
  ...
  return (
    <span
      className={cn(
        ...
        "bg-white/90 px-2.5 py-1 font-mono text-[8.5px] uppercase tracking-[0.12em] ring-1 ring-black/10 backdrop-blur-sm",
        tone === "urgent" ? "text-[#CC0C39]" : "text-neutral-900"
      )}
    >
      <span
        aria-hidden
